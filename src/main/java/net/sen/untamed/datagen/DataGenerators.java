...
import net.sen.untamed.datagen.language.*;
import net.sen.untamed.datagen.loottable.*;
import net.sen.untamed.datagen.models.*;
import net.sen.untamed.datagen.recipes.*;
import net.sen.untamed.datagen.tags.*;
...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(true, new PackMetadataGenerator(output).add(PackMetadataSection.TYPE, new PackMetadataSection(
                Component.literal("Minecraft Untamed Resources"),
